# Yugo
![Yugo logo](frontend/src/assets/Just_Yugo_transparent.png) is your go to app for college students looking for a ride. Whether it's a quick grocery run, a party, or a flight, feel secure knowing that only fellow students can use the app. So start riding today!
